//
//  SYNGPUImageFlowDifferenceOfGaussiansFilter1.m
//  Thred
//
...
@implementation SYNGPUImageFlowDifferenceOfGaussiansFilter1 {
    GLuint _imageSizeUniform, _sigmaMUniform, _phiUniform, _epsilonUniform;
    CGSize _imageSize;
    CGFloat _sigmaM, _phi, _epsilon;
}

NSString *const kSYNGPUImageFlowDifferenceOfGaussians1FragmentShader = SHADER_STRING(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kSYNGPUImageFlowDifferenceOfGaussians1FragmentShader]) {
