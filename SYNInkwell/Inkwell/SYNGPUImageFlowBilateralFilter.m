//
//  SYNGPUImageFlowBilateralFilter.m
//  SYNInkwell
//
...
@implementation SYNGPUImageFlowBilateralFilter {
...
NSString *const kSYNGPUImageFlowBilateralFragmentShader = SHADER_STRING(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kSYNGPUImageFlowBilateralFragmentShader]) {
