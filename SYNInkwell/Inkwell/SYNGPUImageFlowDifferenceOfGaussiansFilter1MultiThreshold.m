//
//  SYNGPUImageFlowDifferenceOfGaussiansFilter1MultiThreshold.m
//  Thred
//
...
@implementation SYNGPUImageFlowDifferenceOfGaussiansFilter1MultiThreshold {
...
NSString *const kSYNGPUImageFlowDifferenceOfGaussians1MTShader = SHADER_STRING(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kSYNGPUImageFlowDifferenceOfGaussians1MTShader]) {
