...
@implementation SYNGPUImageRGBToLABFilter

NSString *const kSYNGPUImageRGBToLABFragmentShader = SHADER_STRING(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kSYNGPUImageRGBToLABFragmentShader]) {
    }
    return self;
}
