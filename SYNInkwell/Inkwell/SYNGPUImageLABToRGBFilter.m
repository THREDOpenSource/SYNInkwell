...
@implementation SYNGPUImageLABToRGBFilter

NSString *const kSYNGPUImageLABToRGBFragmentShader = SHADER_STRING(
...
- (id)init
{
    if (self = [super initWithFragmentShaderFromString:kSYNGPUImageLABToRGBFragmentShader]) {
    }
    return self;
}
